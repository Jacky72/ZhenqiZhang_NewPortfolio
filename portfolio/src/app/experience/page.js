        ...
        <section className="min-h-screen bg-[#F4D6B9]">
            ...
            {selectedExp && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-transparent bg-opacity-50 backdrop-blur-sm">
                    <div className="bg-white rounded-xl shadow-2xl p-8 max-w-lg w-full md:max-w-3xl relative border-2 border-black/50 justify-center text-center overflow-y-auto max-h-[95vh]">
                        <button
                        ...
                        />
                        <p className="text-gray-700 mb-12 text-center md:px-15 px-5">{selectedExp.short}</p>
                        <a
